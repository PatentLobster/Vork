...
export default {
  ...
  methods: {
    setMonth(event)  {
      console.log(event)
      // ("YYYY-MM");
      this.FETCH_DAYS(`${event.year}-${event.month}`);
    },
    getRows() {
